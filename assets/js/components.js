                ...
                <div class="header-container">
                    ...
                    <div class="header-nav">
                        ...
                        <a class="group btn-acquire" href="${acquireLink}">
                            ...
                            <span
                                class="relative text-sm uppercase font-serif font-bold tracking-[0.25em] group-hover:tracking-[0.3em] transition-all text-primary" data-i18n="nav_acquire">Sahip Ol</span>
                        </a>
                    </div>
        ...
        return `
            <div class="footer-content">
                <div class="footer-brand">
                    ...
                    <p class="footer-copyright" data-i18n="footer_made">© 2024. Nowhere'in Gölgelerinde El ile Yapıldı.</p>
                </div>
                <div class="footer-links">
                    ...
                    <a class="footer-link-item" href="#" data-i18n="footer_links_contact">İletişim</a>
